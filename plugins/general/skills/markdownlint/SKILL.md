...
name: markdownlint
description: >
    Use when generating or modifying Markdown files under plugins/general/skills directory. Triggers on Markdown file creation or modification in the general skills workspace.
version: "1.0.0"
...
- Triggered when creating new Markdown files (`.md` extension) under `plugins/general/skills/`.
...
npx markdownlint plugins/general/skills/**/*.md
