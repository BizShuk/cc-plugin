...
- [ ] Step 2: Classify the content shape (Index / Article / Video / Document)
- [ ] Step 3: Summarize using the matching strategy
- [ ] Step 4: Extract 1-3 business-value / opportunity ideas (brainstorm)
- [ ] Step 5: Assemble the output; offer calendar / notes follow-ups
```
...
## Step 4 — Business value (1-3 ideas)
...
## Step 5 — Calendar & Notes follow-ups
